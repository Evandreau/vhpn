...
const translations: Record<Language, Record<string, string>> = {
  nl: {
    ...
    'filters.anyBudget': 'Alle budgetten',
    ...
    'form.captchaFailed': 'Captcha-verificatie mislukt. Vernieuw de pagina en probeer opnieuw.',
  ...
  en: {
    ...
    'listings.availableInConsultation': 'In consultation',
    ...
    'form.captchaFailed': 'Captcha verification failed. Please refresh the page and try again.',

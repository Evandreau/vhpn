  ...
  const content = {
    nl: {
      ...
      sections: [
        ...
        {
          title: "6. Uw rechten",
          content: "Onder de AVG heeft u de volgende rechten:\n\n• Recht op inzage in uw persoonsgegevens\n• Recht op rectificatie van onjuiste gegevens\n• Recht op verwijdering ('recht om vergeten te worden')\n• Recht op beperking van de verwerking\n• Recht op dataportabiliteit\n• Recht om bezwaar te maken tegen verwerking\n• Recht om toestemming in te trekken\n\nU kunt uw rechten uitoefenen door contact op te nemen via info@haven.nl."
        },
        {
          title: "7. Beveiliging",
          content: "Wij nemen passende technische en organisatorische maatregelen om uw persoonsgegevens te beschermen tegen verlies, ongeautoriseerde toegang, publicatie en onrechtmatige verwerking. Onze website maakt gebruik van SSL-versleuteling."
        },
        {
          title: "8. Delen met derden",
          content: "Wij delen uw gegevens alleen met:\n\n• Verhuurders (alleen relevante informatie voor de huurderscreening)\n• IT-dienstverleners voor het beheren van onze systemen\n• Overheidsinstanties indien wettelijk verplicht\n\nWij verkopen uw gegevens nooit aan derden."
        },
        {
          title: "9. Cookies",
          content: "Onze website maakt gebruik van functionele cookies voor het goed functioneren van de website en om uw taalvoorkeuren te onthouden. Wij gebruiken geen tracking cookies voor marketingdoeleinden zonder uw uitdrukkelijke toestemming."
        },
        {
          title: "10. Klachten",
    ...
    en: {
      ...
      sections: [
        ...
        {
          title: "9. Cookies",
          content: "Our website uses functional cookies for the proper functioning of the website and to remember your language preferences. We do not use tracking cookies for marketing purposes without your explicit consent."
        },
        {
          title: "10. Complaints",

...
const Terms = () => {
  ...
  const content = {
    nl: {
      ...
      sections: [
        { title: "1. Definities", content: "• VHPN: de verhuurmakelaar die bemiddelt bij de verhuur van woningen\n• Opdrachtgever: de verhuurder die VHPN opdracht geeft tot bemiddeling\n• Kandidaat-huurder: de partij die via VHPN een woning zoekt\n• Woning: het gehuurde object\n• Bemiddelingsovereenkomst: de overeenkomst tussen VHPN en de opdrachtgever" },
        { title: "2. Dienstverlening", content: "VHPN biedt de volgende diensten aan:\n\n• Bemiddeling bij verhuur van woningen\n• Huurderscreening en selectie\n• Professionele vastgoedfotografie\n• Marketing en promotie van huurwoningen\n• Opstellen van huurovereenkomsten\n• Begeleiding bij oplevering\n\nOnze diensten zijn gericht op de regio's Rotterdam, Amsterdam, Den Haag, Schiedam en Vlaardingen." },
        { title: "3. Bemiddelingskosten", content: "VHPN brengt bemiddelingskosten uitsluitend in rekening bij de verhuurder, conform de Wet doorberekening huurdersbemiddelingskosten. Aan kandidaat-huurders worden geen bemiddelingskosten in rekening gebracht.\n\nDe exacte tarieven worden vooraf in de bemiddelingsovereenkomst vastgelegd." },
        { title: "4. Huurderscreening", content: "VHPN voert een zorgvuldige screening uit van kandidaat-huurders. Deze screening kan omvatten:\n\n• Verificatie van identiteit\n• Controle van inkomen en arbeidsverhouding\n• Referenties van vorige verhuurders\n• Controle bij het Bureau Krediet Registratie (BKR)\n\nKandidaat-huurders stemmen in met deze screening door het indienen van hun gegevens." },
        { title: "5. Geen garantie", content: "VHPN spant zich in om geschikte huurders te vinden, maar garandeert niet:\n\n• Dat een woning binnen een bepaalde termijn wordt verhuurd\n• Dat een huurder gedurende de gehele huurperiode aan alle verplichtingen voldoet\n• De juistheid van door kandidaat-huurders verstrekte informatie\n\nVHPN is niet aansprakelijk voor schade door wanbetaling of wangedrag van huurders." },
        { title: "6. Aansprakelijkheid", content: "VHPN is slechts aansprakelijk voor directe schade die het gevolg is van opzet of grove nalatigheid. De aansprakelijkheid is beperkt tot het bedrag van de bemiddelingsvergoeding.\n\nVHPN is niet aansprakelijk voor:\n• Indirecte schade, gevolgschade of gederfde winst\n• Schade door handelen of nalaten van derden\n• Schade door onjuiste of onvolledige informatieverstrekking door partijen" },
        { title: "7. Verplichtingen verhuurder", content: "De verhuurder verplicht zich om:\n\n• Correcte en volledige informatie over de woning te verstrekken\n• De woning in goede staat op te leveren\n• VHPN direct te informeren over wijzigingen in beschikbaarheid\n• Zich te houden aan geldende wet- en regelgeving (waaronder het Besluit Huurprijzen Woonruimte indien van toepassing)" },
        { title: "8. Verplichtingen kandidaat-huurder", content: "De kandidaat-huurder verplicht zich om:\n\n• Correcte en volledige informatie te verstrekken\n• Tijdig de gevraagde documenten aan te leveren\n• Bezichtigingsafspraken na te komen of tijdig af te zeggen" },
        { title: "9. Intellectueel eigendom", content: "Alle door VHPN gemaakte foto's, teksten en overige content blijven eigendom van VHPN. Gebruik is slechts toegestaan met uitdrukkelijke schriftelijke toestemming." },
        { title: "10. Klachten", content: "Klachten over onze dienstverlening kunt u indienen via info@vhpn.nl. Wij behandelen uw klacht binnen 14 werkdagen. Indien u niet tevreden bent met de afhandeling, kunt u zich wenden tot de Huurcommissie of de bevoegde rechtbank." },
        { title: "11. Toepasselijk recht", content: "Op deze algemene voorwaarden is Nederlands recht van toepassing. Geschillen worden voorgelegd aan de bevoegde rechtbank te Rotterdam." },
        { title: "12. Wijzigingen", content: "VHPN behoudt zich het recht voor deze algemene voorwaarden te wijzigen. Wijzigingen treden in werking 30 dagen na publicatie op de website." }
      ]
    },
    en: {
      ...
      sections: [
        { title: "1. Definitions", content: "• VHPN: the rental agency that mediates in the rental of properties\n• Client: the landlord who commissions VHPN to mediate\n• Prospective tenant: the party looking for a property through VHPN\n• Property: the rented object\n• Mediation agreement: the agreement between VHPN and the client" },
        { title: "2. Services", content: "VHPN offers the following services:\n\n• Mediation in property rentals\n• Tenant screening and selection\n• Professional real estate photography\n• Marketing and promotion of rental properties\n• Drafting of rental agreements\n• Assistance with handover\n\nOur services are focused on the regions of Rotterdam, Amsterdam, The Hague, Schiedam and Vlaardingen." },
        { title: "3. Mediation fees", content: "VHPN charges mediation fees exclusively to the landlord, in accordance with Dutch law on tenant mediation fees. No mediation fees are charged to prospective tenants.\n\nThe exact rates are agreed upon in advance in the mediation agreement." },
        { title: "4. Tenant screening", content: "VHPN conducts careful screening of prospective tenants. This screening may include:\n\n• Identity verification\n• Income and employment verification\n• References from previous landlords\n• Credit check\n\nProspective tenants consent to this screening by submitting their data." },
        { title: "5. No guarantee", content: "VHPN endeavors to find suitable tenants, but does not guarantee:\n\n• That a property will be rented within a certain period\n• That a tenant will meet all obligations throughout the rental period\n• The accuracy of information provided by prospective tenants\n\nVHPN is not liable for damage caused by non-payment or misconduct by tenants." },
        { title: "6. Liability", content: "VHPN is only liable for direct damage resulting from intent or gross negligence. Liability is limited to the amount of the mediation fee.\n\nVHPN is not liable for:\n• Indirect damage, consequential damage or lost profits\n• Damage caused by acts or omissions of third parties\n• Damage caused by incorrect or incomplete information provided by parties" },
        { title: "7. Landlord obligations", content: "The landlord undertakes to:\n\n• Provide correct and complete information about the property\n• Deliver the property in good condition\n• Inform VHPN immediately about changes in availability\n• Comply with applicable laws and regulations" },
        { title: "8. Prospective tenant obligations", content: "The prospective tenant undertakes to:\n\n• Provide correct and complete information\n• Submit requested documents in a timely manner\n• Keep viewing appointments or cancel in a timely manner" },
        { title: "9. Intellectual property", content: "All photos, texts and other content created by VHPN remain the property of VHPN. Use is only permitted with explicit written permission." },
        { title: "10. Complaints", content: "Complaints about our services can be submitted via info@vhpn.nl. We will handle your complaint within 14 working days. If you are not satisfied with the handling, you can contact the Rent Tribunal or the competent court." },
        { title: "11. Applicable law", content: "Dutch law applies to these general terms and conditions. Disputes are submitted to the competent court in Rotterdam." },
        { title: "12. Changes", content: "VHPN reserves the right to change these general terms and conditions. Changes take effect 30 days after publication on the website." }
      ]
    }
  };
  ...
  const seoTitle = language === 'nl' ? 'Algemene Voorwaarden — VHPN' : 'Terms of Service — VHPN';
  const seoDescription = language === 'nl'
    ? 'Algemene voorwaarden van VHPN verhuurmakelaar. Lees over onze diensten, bemiddelingskosten en aansprakelijkheid.'
    : 'Terms of service of VHPN rental agency. Read about our services, mediation fees and liability.';

  const breadcrumbItems = [
    { name: 'Home', url: 'https://vhpn.nl/' },
    { name: t.title, url: 'https://vhpn.nl/terms' },
  ];

  return (
    <>
      <SEO title={seoTitle} description={seoDescription} url="/terms" />
      <Helmet>
